                ...
                <div class="col-sm-12 mt-2 col-md-6 col-lg-4">
                    <div class="position-relative card p-2" style="border-color: var(--warna-keempat)">
                        <div class="p-0 position-relative">
                            <div class="position-absolute bottom-0 top-0 en d-0 d-flex justify-content-center align-items-center" style="width: 100%; background-color: rgba(0, 0, 0, 0.7); color: white; padding: 10px; "><h1>STOK HABIS</h1></div>
