...
@section('content')
  <section class="mb-5">
    ...
    <div class="d-flex justify-content-center align-items-center fixed-bottom bg-white py-2 flex-column" >
      <div class="total w-100 d-flex justify-content-end fs-3 fw-bold " style="max-width: 400px">Rp 99.999</div>
      <div class="btn bg-kedua color-utama w-100 mw-50 " style="max-width: 400px">Checkout</div>
    </div>
